...
public class OssFileUtil {
     ...
     * 阿里云ACCESS_ID
     */
    public static final String ACCESS_KEY_ID = "LTAIMa3tdTEOS25y";

    /**
     * 阿里云ACCESS_KEY
     */
    public static final String ACCESS_KEY_SECRET = "0omizrbhpAzv7l7bvpL9CW7RSc3pz2";
     ...
     * 阿里云BUCKET_NAME OSS
     */
    public static final String BUCKET_NAME = "daka-jiaju";
    ...
    public static void appendLocalFile(String content, String fileName) {
        ...
        try {
            String fileFullName = DEBUG_FILE_STORAGE_PATH + fileName;
    ...
    public static void main(String[] args) {
        try {
            File file = new File("F:\\share.jpg");
            FileInputStream inputStream = new FileInputStream(file);
            uploadFile(inputStream,"test.jpg");
        }catch (Exception e){
